...
--
-- Table structure for table `DEPADMS`
--

DROP TABLE IF EXISTS `DEPADMS`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `DEPADMS`
--

LOCK TABLES `DEPADMS` WRITE;
/*!40000 ALTER TABLE `DEPADMS` DISABLE KEYS */;
/*!40000 ALTER TABLE `DEPADMS` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `ESCOLAS` (
  ...
  `DEPADM_ID` int(11) NOT NULL,
  `ENDERECO_ID` int(11) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `TIPO_ID` (`TIPO_ID`),
  KEY `DIRETORIA_ID` (`DIRETORIA_ID`),
  KEY `DEPADM_ID` (`DEPADM_ID`),
  KEY `ENDERECO_ID` (`ENDERECO_ID`),
  ...
  CONSTRAINT `ESCOLAS_ibfk_3` FOREIGN KEY (`DEPADM_ID`) REFERENCES `DEPADMS` (`ID`),
...
-- Dump completed on 2018-01-23  1:20:16
